...
>
> Also, the `titlebar_active` and `window_border` variables don't return the same color. The window border color is slightly different than the active titlebar color.
